...
В ряде случаев удобный способ использования дискового пространства, например для файлообменных сетей, виртуальных дисков виртуальных машин и т.п. 
```
2. Могут ли файлы, являющиеся жесткой ссылкой на один объект, иметь разные права доступа и владельца? Почему?
```
Права будут одни и те же, т.к. файл и жесткая ссылка на него имеют один и тот же индексный дескриптор inode
```
