...
```
   ...
   root        1553  0.0  0.0   8076   596 pts/0    S    17:29   0:00 /bin/sleep 1h
   root        1563  0.0  0.0   8080   524 pts/1    S+   17:30   0:00 unshare -f --pid --mount-proc /bin/sleep 1h
   root        1564  0.0  0.0   8076   592 pts/1    S+   17:30   0:00 /bin/sleep 1h
   root        1566  0.0  0.0   8900   740 pts/2    S+   17:30   0:00 grep --color=auto sleep
   root@vagrant:~# nsenter --target 1553 --pid --mount
   root@vagrant:/# ps aux
   USER         PID %CPU %MEM    VSZ   RSS TTY      STAT START   TIME COMMAND
   root           1  0.0  0.0   8076   596 pts/0    S+   17:29   0:00 /bin/sleep 1h
   root           2  0.0  0.1   9836  4188 pts/2    S    17:30   0:00 -bash
   root          11  0.0  0.0  11492  3356 pts/2    R+   17:30   0:00 ps aux
```
